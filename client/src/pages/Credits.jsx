    ...
    <div className='max-w-7xl h-screen overflow-y-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {plans.map((plan)=>(
          ...
          hover:shadow-lg transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id === "pro" ? "bg-purple-50 dark:bg-purple-900" : "bg-white dark:bg-transparent" }`}>
            ...
            <button onClick={()=> toast.promise(purchasePlan(plan._id), {loading: 'Processing...'})}
              className='mt-6 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white
